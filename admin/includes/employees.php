		...
		<table class="table table-striped ">
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="admin.php?action=edit_employee&edit_id=<?php echo $employee_id; ?>">Edit</a></td>
					<td>
						<form action="" role="form" name="deleteemployee" method="POST">
							<input type="hidden" name="employee_id" value="<?php echo $employee_id; ?>">
							<button type="button" class="btn btn-sm btn-link text-danger btn-block hidden-print" name="delete" onclick="setDeleteAction()">Delete
							</button>
						</form>
					</td>
				</tr>
