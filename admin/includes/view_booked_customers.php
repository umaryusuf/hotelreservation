<div class="row">
	<div class="col-md-12">
		<div class="btn-group btn-group-justified">
		  <a href="admin.php?action=customers" class="btn btn-primary">View all customers</a>
		  <a href="admin.php?action=view_booked_customers" class="btn btn-primary active">View Booked Customers</a>
		</div>
	</div>
</div>
<br>
...
<div class="row">
	<div class="col-md-10 col-md-offset-1">
		<table class="table">
			...
			<tbody>
				<?php 
					$q = "SELECT user_id FROM reserved_rooms";
