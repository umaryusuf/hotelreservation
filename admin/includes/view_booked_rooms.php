<div class="row">
  <div class="col-md-12">
    <div class="btn-group btn-group-justified">
      ...
      <a href="admin.php?action=view_booked_rooms" class="btn btn-primary active">Booked rooms</a>
...
$q = "SELECT * FROM `rooms` WHERE booked='1'";
...
?>
  <div class="col-md-4">
    <div class="well">
      <img class="img img-responsive" src="./img/<?php echo $room_image; ?>" alt=" hotel room image" style="max-width: 100%;height: 200px;width: 100%;">
      <div>
